...
Syinx is a Chrome extension that injects your typed prompt into your already-logged-in ChatGPT, Claude, and Gemini tabs simultaneously. No backend, no API keys, no subscriptions. It rides your existing authenticated browser sessions.
...
Syinx solves this by operating directly on your logged-in browser tabs — like a power user copy-pasting, but automated.

## Install

### From Chrome Web Store

_(Coming soon — under review)_
...
1. You type a prompt in the Syinx popup.
...
See [`Syinx-architecture-spec.md`](./Syinx-architecture-spec.md) for the full technical spec.
